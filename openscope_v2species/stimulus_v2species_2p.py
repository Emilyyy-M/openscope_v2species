...
if __name__ == "__main__":
    ...
    # (edited): 
    nb_runs_ephys_rf = json_params.get('num_reps_rf', 10)
    nb_run_gratings = json_params.get('num_reps_grating', 15)
    inter_block_interval = json_params.get('inter_block_interval', 10)
    ...
    current_time = 0
    length_rf_seconds = 0.25 * 243 * nb_runs_ephys_rf
    ...
    length_drifting_grating_seconds = 2.25 * 100 * nb_run_gratings / 15
